...
public class CodeGenerator {
    ...
    public static class DBDispatcher {
        ...
        public String rebuildQuery(String query) {
            ...
            String hashKey = target.getTableHashKey();
    ...
    public interface PolicySQLGenerator {
    ...
    public final String appendInsert() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("\nlong id = JDBCBuilder.insert(\"insert into `" + obj.getTableName() + "`(");
    ...
    public final String appendUpdate() {
        ...
        sb.append("long updateNum = JDBCBuilder.insert(\"update `" + obj.getTableName() + "` set ");
    ...
    public final String appendListFetcher() {
        ...
        sb.append("super(false, true, whereQuery, params);\n");
        sb.append("StringBuilder sb = new StringBuilder();\n");
        sb.append("sb.append(\"" + appendSelect() + "\");\n");
//        sb.append("sb.append(\" from \");\n");
//        sb.append("sb.append(TABLE_NAME);\n");
        sb.append("sb.append(" + obj.getClass().getSimpleName() + "._instance.getTableHashId(hashKeyId));\n");
...
//        sb.append(obj.getHashColumnName());
    ...
    public final String appendCounter() {
        ...
        sb.append("public static int count(Long hashKeyId, String whereQuery, Object... params) {\n");
        sb.append("StringBuilder sb = new StringBuilder();\n");
